/***********************************************************************//**
 * @file	: lpc13xx_syscon.c
 * @brief	: Contains all functions support for SYSCON firmware library on lpc13xx
 * @version	: 1.0
 * @date	: 20. Jan. 2010
 * @author	: Coocox
 **********************************************************************/
 ...
 *              - SYSCON_RSTPeriph_SSP : Reset SSP
 ...
 *              - SYSCON_ABLOCK_WDTOSC : Watchdog oscillator wake-up configuration
 *              - SYSCON_ABLOCK_SYSPLL : System PLL wake-up configuration
 *              - SYSCON_ABLOCK_USBPAD : USB PLL wake-up configuration
 *              - SYSCON_ABLOCK_USBPLL : USB pad wake-up configuration
 * @param[in]  NewState  power state, it can be:
...
{
    if(SYSCON_GetAHBClockDiv() == 0) {
        return 0;
    } else {
        return (SystemFrequency/SYSCON_GetAHBClockDiv());
    }
}

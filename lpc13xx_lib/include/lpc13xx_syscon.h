/***************************************************************************
 * @file	: lpc13xx_syscon.h
 * @brief	: Contains all macro definitions and function prototypes
 * 				support for system configuration firmware library on lpc13xx
 * @version	: 1.0
 * @date	: 20. Jan. 2010
 * @author	: Coocox
 **************************************************************************/
...
#ifndef __lpc13XX_SYSCON_H_
#define __lpc13XX_SYSCON_H_
...
#define	 SYSCON_AHBPeriph_SSP          ((uint32_t)(1<<11))
...
**********************************************************************/
#define  SYSCON_RSTPeriph_SSP     ((uint32_t)(1<<0))  
...
#define  SYSCON_ABLOCK_USBPLL       ((uint32_t)1 << 8)
/** USB pad wake-up configuration */
#define  SYSCON_ABLOCK_USBPAD       ((uint32_t)1 << 10)
...
#define  SYSCON_GetSPIClockDiv()          (LPC_SYSCON->SSPCLKDIV & 0xFF)
...
void SYSCON_SetSPIClockDiv (uint32_t DivVal);
...
uint32_t SYSCON_GetAHBClock(void);
uint32_t SYSCON_GetWDTClock(void);
uint32_t SYSCON_GetSSPClock(void);
